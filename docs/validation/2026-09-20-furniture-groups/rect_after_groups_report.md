...
Items moved: 2. Unresolved items/groups: 0.

| Item | Group | Room | From | To | Cleared |
| --- | --- | --- | --- | --- | --- |
| Desk | desk-set | Office | (13.0, 1.0) | (13.0, 4.0) | Bedroom door |
| Desk Chair | desk-set | Office | (17.5, 1.0) | (17.5, 4.0) | Bedroom door |

## Room Stats

| Room | Area sq ft | Free sq ft | Items | Containment | Overlap | Door | Heuristic clearance notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Bedroom | 168.0 | 117.0 | 5 | 0 | 0 | 0 | 5 |
| Office | 112.0 | 100.0 | 2 | 0 | 0 | 0 | 3 |
