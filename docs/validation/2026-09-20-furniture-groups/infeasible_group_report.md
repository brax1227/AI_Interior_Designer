...
| door clearance | fail | 1 | floor-level items intersecting a door swing square or approach strip |
| walkable path | unmeasured | n/a | Not implemented. No claim is made about circulation between doors or around furniture. |

Modelled violations: 1. Unmeasured: walkable_path.

### door clearance findings

- Desk Chair (Office) blocks the swing clearance of the Office door

## Door-aware placement pass

Items moved: 0. Unresolved items/groups: 1.
- UNRESOLVED: Desk + Desk Chair in Office still blocks the Office door: no shift up to 4.0 ft keeps the group Desk + Desk Chair inside the room, clear of door zones and of other furniture.

## Room Stats

| Room | Area sq ft | Free sq ft | Items | Containment | Overlap | Door | Heuristic clearance notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Office | 54.0 | 42.0 | 2 | 0 | 0 | 1 | 3 |
